...
- [ ] SellerDashboard: исправить загрузку нескольких фото (до 10 штук) с предпросмотром и удалением
- [ ] SellerDashboard: показывать миниатюры загруженных фото перед отправкой
- [ ] SellerDashboard: кнопка удаления каждого фото
