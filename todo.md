...
## v24 - Оптимизация мобильной производительности
- [x] Lazy loading для всех страниц (React.lazy + Suspense в App.tsx)
- [x] Vite: настроить manualChunks для vendor-splitting (react, trpc, lucide отдельно)
- [x] Vite: включить build.cssCodeSplit и minify terser
- [x] Оптимизация шрифтов: font-display: swap, preconnect для Google Fonts
- [x] Добавить preconnect/dns-prefetch для API и CDN в index.html
- [x] Изображения: loading="lazy" для всех img тегов на карточках товаров
- [x] Skeleton loaders для ProductCard и ProductDetail вместо пустого экрана
- [x] Убрать console.log из production build
