...
## v147 - Удалены дублирующиеся кнопки WhatsApp/Telegram на странице товара
- [x] ProductDetail.tsx: удалён старый блок «Row 1b: Связаться с продавцом — полная ширина» (строки 793-865) — дублировал компактную строку из 3 кнопок
- [x] Row 3 «Seller contacts» уже был чистым (только имя продавца + дисклеймер)
- [x] TypeScript: 0 ошибок
