...
- [ ] Navbar: вкладка "юноша" → "Хиты продаж" (звёздочка)
- [ ] Admin.tsx категории: заголовки "Источник"→"Название", "Слизняк"→"URL (slug)", "нёд"→"Действия", "+ фил"→"+ Добавить категорию"
- [ ] Admin.tsx категории: "житель" = категория кондиционеры с узбекским именем nameUz — исправить отображение
- [ ] Admin.tsx: вкладка "Настройки" показывает "толстый" — исправить
- [ ] Admin.tsx: раздел "Уведомления" показывает "у касса ран" — исправить
- [ ] Admin.tsx форма товара: "Фильтр" → убрать или переименовать понятно
- [ ] Найти файл переводов и исправить все неправильные ключи
