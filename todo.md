...
- [ ] Admin.tsx: исправить названия вкладок (юноша→?, толстый→?, У касса ран→?)
- [ ] Admin.tsx: исправить заголовки таблицы (ли→Товар, туалет→Статус, лёд→Действия)
- [ ] Admin.tsx: исправить кнопку "+ фил" → "+ Добавить товар"
- [ ] Admin.tsx: исправить счётчик "выйти (0)" → "Товары (N)"
- [ ] Admin.tsx: исправить форму добавления товара (все узбекские поля)
- [ ] Оптимизация: lazy loading для страниц в App.tsx
