...
- [ ] Cart.tsx: добавить баннер «Войдите для быстрого оформления» для неавторизованных
- [ ] Checkout.tsx: добавить баннер «Войдите для быстрого оформления» для неавторизованных
