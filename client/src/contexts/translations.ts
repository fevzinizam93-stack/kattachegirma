// Translations split into a separate module so Rollup can tree-shake
// and potentially put them in a separate chunk away from the critical boot path.
...
export const uz: Translations = {
  ...
  profile_no_orders: "Hali buyurtmalar yo'q",
  ...
  admin_confirm_delete: "O'chirishni tasdiqlaysizmi?",
