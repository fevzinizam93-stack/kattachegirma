        ...
        <div className="container py-2.5 flex items-center gap-4">
          ...
          <Link href="/" className="shrink-0 flex items-center gap-2 min-w-fit">
            <div className="flex items-center justify-center w-9 h-9">
              <img src="/manus-storage/kc-logo-black-transparent_ad9652b5.png" alt="KC" className="h-9 w-auto object-contain" />
            </div>
        ...
        <div className="flex items-center px-3 pt-2 pb-1">
          <Link href="/" className="flex items-center gap-1.5 min-w-0">
            <div className="flex items-center justify-center w-8 h-8 shrink-0">
              <img src="/manus-storage/kc-logo-black-transparent_ad9652b5.png" alt="KC" className="h-8 w-auto object-contain" />
            </div>
