        ...
        <div className="mt-auto">
          ...
          <div className="flex gap-1.5 mb-3">
            <div className="flex items-center gap-1 bg-[#d4af37]/10 border border-[#d4af37]/40 rounded-full px-2 py-0.5">
              ...
              <span className="text-[#b8860b] text-[9px] font-semibold">{t.original}</span>
            </div>
            <div className="flex items-center gap-1 bg-gray-50 border border-gray-200 rounded-full px-2 py-0.5">
              ...
              <span className="text-gray-500 text-[9px] font-semibold">{t.guarantee}</span>
            </div>
          </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-[#fffdf5] to-[#fef9e7] border-b border-[#d4af37]/20">
        ...
        <div className="relative container py-10 md:py-14">
          ...
          <div className="flex items-center gap-2 text-gray-400 text-xs mb-6">
            ...
            <span className="text-[#b8860b] font-semibold">{t.title}</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={label} className="flex items-center gap-2 bg-[#d4af37]/10 border border-[#d4af37]/40 rounded-xl px-3 py-2">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-20">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-[#b8860b]/60 text-sm">{t.loading}</p>
            </div>
          </div>
        ) : filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-gray-600 font-semibold">{t.no_products}</p>
            <p className="text-gray-400 text-sm">{t.no_products_sub}</p>
          </div>
        ) : (
          <>
      ...
      <div className="border-t border-[#d4af37]/20 bg-gradient-to-r from-white via-[#fffdf5] to-white">
        <div className="container py-8">
          <div className="flex flex-col md:flex-row items-center gap-4 justify-center text-center">
            ...
            <p className="text-gray-500 text-sm max-w-lg">{t.premium_promise}</p>
          </div>
        </div>
      </div>
    </div>
