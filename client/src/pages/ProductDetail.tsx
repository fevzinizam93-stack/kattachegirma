              ...
              <div className="space-y-2">
                ...
                <div className="flex items-stretch gap-2">
                  ...
                  <button
                    ...
                    disabled={(product.stock ?? 0) === 0}
                    className="press ripple flex-1 flex flex-col items-center justify-center gap-1 h-[58px] rounded-2xl border border-gray-200 bg-white text-gray-700 hover:border-primary/40 hover:bg-primary/5 active:scale-[0.96] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    ...
                    return (
                      <div className="relative flex-1">
                        <button
                          ...
                          className="press ripple w-full flex flex-col items-center justify-center gap-1 h-[58px] rounded-2xl border border-gray-200 bg-white text-gray-700 hover:border-emerald-300 hover:bg-emerald-50 active:scale-[0.96] transition-all"
                        >
                  ...
                  <button
                    ...
                    className="press ripple flex-1 flex flex-col items-center justify-center gap-1 h-[58px] rounded-2xl border border-gray-200 bg-white text-gray-500 hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50/60 active:scale-[0.96] transition-all"
                  >
                  ...
                  <div className="relative flex-1">
                    <button
                      ...
                      className="press ripple w-full flex flex-col items-center justify-center gap-1 h-[58px] rounded-2xl border border-gray-200 bg-white text-gray-500 hover:border-gray-300 hover:bg-gray-50 active:scale-[0.96] transition-all"
                    >
                      <Share2 size={18} />
    ...
    {(product.stock ?? 0) > 0 && (
      <div className="md:hidden fixed left-0 right-0 z-[60] bg-white border-t border-gray-200 px-4 pt-3 shadow-[0_-4px_20px_rgba(0,0,0,0.10)]" style={{ bottom: '56px', paddingBottom: '12px' }}>
        <div className="flex gap-3 items-center">
          ...
          <button
            onClick={() => setQuickBuyOpen(true)}
            className="press ripple h-12 px-4 rounded-2xl border-2 border-primary text-primary font-black text-sm flex items-center justify-center gap-1.5 active:scale-[0.98] transition-all"
          >
            <Zap size={16} />
            1 клик
          </button>
